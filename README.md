...
- Designed and provisioned **22 AWS resources** (VPC, EKS, EC2, S3, IAM) using modular, **immutable Terraform infrastructure as code**, following a full apply → verify → destroy discipline to prove IaC competency without incurring ongoing cloud cost.
...
**⏭️ Not implemented (scoped out, planned):**
